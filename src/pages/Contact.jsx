...
const contactMethods = [
  {
    icon: Mail,
    title: "Email Us",
    detail: "hello@codedimension.site",
    description:
      "Send us an email anytime. We typically respond within 24 hours.",
    action: "mailto:hello@codedimension.site",
  },
  {
    icon: Phone,
    title: "Call Us",
...
const offices = [
  {
    ...
    email: "hello@codedimension.site",
  },
];
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg md:text-xl max-w-3xl mx-auto">
              Ready to start your next project or have questions? We'd love to
              hear from you. Our team is here to help bring your vision to life.
            </p>
          </div>
        </div>
      </section>
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="pt-4 mt-4 border-t border-border">
                    <p className="text-sm text-muted-foreground">
                      ...
                      For enterprise clients with support contracts, our team is
              ...
              <Card className="bg-gradient-to-br from-primary/10 to-blue-500/10 border-primary/20">
                <CardContent className="p-6">
                  ...
                  <p className="text-muted-foreground mb-4">
                    We value your time. Our team typically responds to all
                    inquiries within 24 hours during business days, and often
                    much faster.
                  </p>
                </CardContent>
              </Card>
